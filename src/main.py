...
def main():
    ...
    if args.web:
        ...
        if web_user and web_password:
            ...
            print_flush("WARNING: No basic auth configured. Set WEB_USER and WEB_PASSWORD environment variables for security.")
    ...
    if not args.url:
        parser.error("URL is required for video processing. Use --download-whisper-model to download models only, or --web to start web server.")
